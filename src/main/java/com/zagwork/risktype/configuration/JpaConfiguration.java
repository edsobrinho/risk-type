package com.zagwork.risktype.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.zagwork.risktype.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.zagwork.risktype.model" });
